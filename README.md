# Heppy-anniversary
Birthday words for teachers can be 
...
<head>
<title>Hugo saja min, ngalah coding ee nake</title>
...
<!-- 
  Made with love by Rayys!
     ...
     Blog: https://paulushugo99.blogspot.com
     Instagram: @hugo_ft_argus
     Snack Video: paulushugo554
     Email: 
...
<body>
   ...
   <div id='Content'>
     ...
     <div><blockquote id='bq' data-text='㋡'>
       ...
       <!-- Pesan -->
       <p id="pesan3">Ciee.. ibu ulang tahun nih ️😆😆</p>
       <p id="pesan4">Happy Birthday, </p>
       <p id="pesan5" class="gaya2">Nambah tua aja ya, hehe</p>
       <p id="pesan6" class="gaya2">Moga panjang umur biar tiap hari bisa memberikan ilmu yang banyak 😆❤️</p>
     ...
     <!-- Pesan Tambahan -->
     <p id="katatambahan" class="sembunyi">Salam terima kasih dari murid kamu 😜</p>
